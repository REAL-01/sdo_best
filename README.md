...
![Каталог курсов в светлом минималистичном стиле](images/lms_catalog.png)

### Структура курса и древовидная навигация (Светлая тема)
![Управление структурой и левая панель навигации](images/lms_structure.png)

### Страница урока с Rutube видеоплеером (Темная тема)
![Интеграция Rutube видеоплеера и контента урока](images/lms_lesson.png)

### Конструктор тестов с расширенными вопросами (Темная тема)
![Конструктор тестов и создание вопросов](images/lms_test_constructor.png)

### Прохождение тестирования студентом (Темная тема)
![Интерфейс ответов на вопросы теста](images/lms_test_taker.png)

### Панель результатов и ручной оценки эссе (Темная тема)
![Управление оценками и ручной ввод баллов преподавателем](images/lms_essay_grading.png)
